...
const stats = [
  { icon: Calendar, value: 3, label: 'Upcoming Appointments', grad: 'from-blue-500 to-blue-600' },
  { icon: FileText, value: 12, label: 'Medical Records', grad: 'from-green-500 to-green-600' },
  { icon: Activity, value: 8, label: 'Completed Consultations', grad: 'from-purple-500 to-purple-600' },
]
      ...
      <div className="mt-6 grid gap-5 md:grid-cols-3">
        {stats.map((s) => (
          <div key={s.label} className={`rounded-2xl bg-gradient-to-br ${s.grad} p-6 text-white shadow-sm`}>
            ...
            <div className="mt-8 text-3xl font-extrabold">{s.value}</div>
