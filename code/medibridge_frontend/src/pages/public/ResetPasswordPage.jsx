...
export default function ResetPasswordPage() {
  ...
  // Get the email and reset token from the password reset link.
  ...
  // Check that the reset link contains the required email and token.
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && data.success) { 
        // Show success message and redirect the user to login.
