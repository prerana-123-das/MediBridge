...
export default function PatientRegisterForm() {
  ...
  // Submits the registration data and handles the next step after successful registration.
  const submit = async (e) => {
    ...
    if (registerPatient.fulfilled.match(res)) {
      ...
      // Returns the user to the page they originally wanted to access, when applicable.
